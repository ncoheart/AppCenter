...
1. 修复收藏夹、收集列表没有增量加载的问题
2. 修复平板模式下“频道探索”模块，已看列表不能滚动的问题
3. 其它UI微调
...
1. 修复点击侧边视频时，视频播放页没有正确加载的问题
2. 在设置中为XBOX添加是否禁用缩放的选项
3. 平板模式下，视频播放页面的分P采用网格展示

## V1.3.2

1. 禁用XBOX上的自动缩放，以维持正常的排版
2. 修复动漫、电影等初次加载无法播放的问题
3. 修复在应用重启后无法正确加载首页的问题

## V1.3.1

1. 修复桌面模式下不能打开视频的问题
2. 修复模式选择界面强制进入平板模式的问题
3. 调整平板模式视频和介绍的布局
4. 修复平板模式个人信息中无法打开追番和追剧列表的问题

## V1.3.0

1. 给排行榜页面添加滚动记录
2. 修复一个点击错误导致点赞按钮失效的问题 (Dino Chen)
3. 调整媒体传输控件的显示方式，在播放器结束加载/开始播放的时候会快速隐藏控件
4. 切P按钮对稍后再看播放列表进行适配
5. 移除桌面模式下流畅网格的选项（低配电脑请使用平板模式）
